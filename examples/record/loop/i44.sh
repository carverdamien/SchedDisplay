...
function kexec_reboot {
    ...
    case ${SLEEP_STATE} in
	'y')
	    APPEND='root=UUID=aef20270-bd86-4e40-a9c0-f09bf8d44b59 ro quiet'
	    ;;
	'n')
	    APPEND='root=root=UUID=aef20270-bd86-4e40-a9c0-f09bf8d44b59 ro quiet processor.max_cstate=1 intel_idle.max_cstate=0'
	    ;;
	*)
